...
| **RF-9: Alquiler LAU** | CUANDO solicita alquiler, EL SISTEMA aplica Ley 29/1994 | `tests/test_legal_spain.test.ts` | APROBADO | Módulo `src/lib/legal/spain/lau.ts` aplica duración legal (5/7 años), prórrogas Arts. 9/10, fianza legal obligatoria Art. 36 y gastos de agencia a arrendador |
